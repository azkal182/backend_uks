...
function generateAccessToken(data) {
    return jsonwebtoken_1.default.sign(data, process.env.TOKEN_SECRET || "secret", { expiresIn: '1800s' });
}
...
const login = (request) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const jwtToken = generateAccessToken({ username: user.username, name: user.name });
